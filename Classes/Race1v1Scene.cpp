...
Scene* Race1v1Scene::createScene()
{
    auto scene = Race1v1Scene::create();
    return scene;
}


void Race1v1Scene::setupCamera() {
...
void Race1v1Scene::setupPowerUps() {
...
void Race1v1Scene::spawnPowerUp() {
...
void Race1v1Scene::checkPowerUpCollisions() {
...
void Race1v1Scene::activatePowerUp(const std::string& type) {
    if (type == "speed") {
...
void Race1v1Scene::updatePowerUps(float delta) {
...
void Race1v1Scene::setupMinimap() {
    auto visibleSize = Director::getInstance()->getVisibleSize();
...
void Race1v1Scene::updateMinimap() {
...
void Race1v1Scene::startCountdown()
{
...
void Race1v1Scene::showCarSelectionMenu()
{
    auto visibleSize = Director::getInstance()->getVisibleSize();
...
void Race1v1Scene::initializeRaceScene()
{
    auto visibleSize = Director::getInstance()->getVisibleSize();
...
bool Race1v1Scene::isKeyPressed(EventKeyboard::KeyCode keyCode) {
    return keyMap[keyCode];
}

void Race1v1Scene::update(float delta)
{
    if (!raceStarted) {
        return;
    }
...
void Race1v1Scene::showEndGameMenu() {
